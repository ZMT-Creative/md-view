...
const DEFAULT_OBSIDIAN_ICONS = setDefaultObsidianIcons()
    ...
    _markdown.renderer.rules.fence = (tokens, idx, options, env, slf) => {
        ...
        if (options.highlight) {
            highlighted =
                ...
                _markdown.utils.escapeHtml(token.content)
        } else {
...
function setDefaultObsidianIcons() {
    const defaultObsidianIcons = {
    ...
    defaultObsidianIcons.abstract = defaultObsidianIcons.summary
    defaultObsidianIcons.attention = defaultObsidianIcons.warning
    defaultObsidianIcons.caution = defaultObsidianIcons.danger
    defaultObsidianIcons.check = defaultObsidianIcons.success
    defaultObsidianIcons.cite = defaultObsidianIcons.quote
    defaultObsidianIcons.done = defaultObsidianIcons.success
    defaultObsidianIcons.error = defaultObsidianIcons.danger
    defaultObsidianIcons.fail = defaultObsidianIcons.failure
    defaultObsidianIcons.faq = defaultObsidianIcons.question
    defaultObsidianIcons.help = defaultObsidianIcons.question
    defaultObsidianIcons.hint = defaultObsidianIcons.tip
    defaultObsidianIcons.history = defaultObsidianIcons.scroll
    defaultObsidianIcons.missing = defaultObsidianIcons.failure
    defaultObsidianIcons.note = defaultObsidianIcons.info
    defaultObsidianIcons.tldr = defaultObsidianIcons.scroll
    defaultObsidianIcons.warn = defaultObsidianIcons.warning

    return defaultObsidianIcons
}
